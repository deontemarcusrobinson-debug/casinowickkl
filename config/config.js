	...
	games: {
		...
		games: {
            ...
            casino: {
                ...
                one_per_provider: String(process.env.CASINO_ONE_PER_PROVIDER || 'false').toLowerCase() === 'true',
                // Default: only the operators you asked to keep (all games from each)
                allowed_providers: (process.env.CASINO_ALLOWED_PROVIDERS || [
                    '100hp',
                    'iconix',
                    'jacks',
                    '7-mojos', '7mojos', '7-mojos-slots', '7mojos-slots',
                    'abracadabra',
                    'airdice',
                    'avatarux',
                    'amigogaming',
                    ...
                    'caletagaming',
                    'onegame',
                    'imagine live', 'imagineliveLS', 'imagineliveHS',
                    'eezecasino',
                    'vivo',
                    'galaxsys', 'galaxsysP'
                ].join(','))
