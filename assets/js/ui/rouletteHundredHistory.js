function rouletteHundredHistory(edata) {
...
try {
  ...
  with (locals || {}) {
    ...
    ; __line = 23
    ;  } 
    ; __append("\n    </div>\n\n    <div class=\"text-lg font-bold\" id=\"roulette_hundred_")
    ; __line = 26
    ; __append(escapeFn( color ))
    ; __append("\">")
