function tableAccountJackpotHistoryRow(edata) {
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("</span>\n        </div>\n    </div>\n\n    <div class=\"table-column text-left\">")
    ; __line = 29
    ; __append(escapeFn( { win: 'Win', loss: 'Loss' }[status] ))
    ; __append("</div>\n    <div class=\"table-column text-left\">")
    ; __line = 30
